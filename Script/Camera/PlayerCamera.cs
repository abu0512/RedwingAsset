...
public class PlayerCamera : MonoBehaviour
{
    ...
    public static PlayerCamera I { get { return _instance; } }
    ...
    LayerMask collisionLayers = -1 << 8;     // What the camera will collide with
    ...
    void Start()
    {
        collisionLayers = 1 << LayerMask.NameToLayer("BG");
    ...
    void LateUpdate()
    {
        ...
        // Set camera rotation
        Quaternion rotation = Quaternion.Euler(yDeg, target.rotation.y + xDeg, 0);
