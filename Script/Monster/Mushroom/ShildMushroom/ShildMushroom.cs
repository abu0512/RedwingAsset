...
public class ShildMushroom : MonsterBase
{
    ...
    // 그로기가 끝났는지
    private bool _groggyend;
    public bool GroggyEnd { set { _groggyend = value; } get { return _groggyend; } }
    ...
    {
        if (_groggy < 100f && !_groggyend)
            return;

        else if(_groggy >= 100f && _groggyend)
        {
